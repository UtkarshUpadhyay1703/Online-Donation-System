...
const EmployeeRegDemo=()=>{
    ...
    return (
        <div>
            <form>
                Name : <input id="name1" name="employeeName" value={employeeob.employeeName} onChange={Change} placeholder="Name"></input><br/><br/>
...
export default EmployeeRegDemo;